...
- (void)setDateLabelText:(UILabel *)label component:(NSInteger)component row:(NSInteger)row {
    if (self.showType == BRDatePickerModeYMDHM) {
        ...
        if (component == 0) {
            label.text = [NSString stringWithFormat:@"%@%@", self.yearArr[row],LocalizedOtherStr(@"Year")];
        } else if (component == 1) {
            label.text = [NSString stringWithFormat:@"%@%@", self.monthArr[row],LocalizedOtherStr(@"Month")];
        } else if (component == 2) {
            label.text = [NSString stringWithFormat:@"%@%@", self.dayArr[row],LocalizedOtherStr(@"Day")];
        }
    } else if (self.showType == BRDatePickerModeYM) {
        if (component == 0) {
            label.text = [NSString stringWithFormat:@"%@年", self.yearArr[row]];
