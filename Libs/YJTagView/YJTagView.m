...
@property (nonatomic, assign) CGFloat selectedRow;
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GoodNormModel *model=[self.dataSource tagView:self titleForItemAtIndex:indexPath.row];
    cell.content =model.norm ;
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewFlowLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    GoodNormModel *model=[self.dataSource tagView:self titleForItemAtIndex:indexPath.row];
    return [YJTagCollectionViewCell getSizeWithContent:model.norm maxWidth:_collectionView.frame.size.width customHeight:self.cellHeight];
}
