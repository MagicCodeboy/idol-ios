...
-(void)awakeFromNib
{
    ...
    _timer2 = [[KKProgressTimer alloc] initWithFrame:CGRectMake(13, 80, 70*SHIJI_WIDTH, 70*SHIJI_HEIGHT)];
    ...
    self.left.constant=10*SHIJI_WIDTH;
    self.right.constant=10*SHIJI_WIDTH;
    self.buttonHight.constant=70*SHIJI_WIDTH;
    self.buttonweath.constant=70*SHIJI_WIDTH;
    ...
    self.lableTime.frame = CGRectMake(45, 100, 30, 30);
    
    self.lableTime.textColor = [UIColor whiteColor];
    
    self.ButtonClick = [[UIButton alloc]initWithFrame:CGRectMake(13, 80, 70, 70)];
